...
namespace DI.System.Controllers
{
    ...
    public class SysMenuController : ControllerBase
    {
        ...
        [DI.System.Log(Title = "菜单管理", BusinessType = BusinessType.INSERT)]
        ...
        [TypeFilter(typeof(DI.Framework.DataValidation.DataValidationFilter))]
        [DI.System.Log(Title = "菜单管理", BusinessType = BusinessType.UPDATE)]
        ...
        [DI.System.Log(Title = "菜单管理", BusinessType = BusinessType.DELETE)]
