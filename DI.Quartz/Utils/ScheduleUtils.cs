...
using DI.Quartz.Constants;
using DI.Quartz.Enums;
using DI.Quartz.Jobs;
using System.Collections.Specialized;

namespace DI.Quartz.Utils
{
    public static class ScheduleUtils
    {
        ...
        private static ISchedulerFactory CreateSchedulerFactory()
        {
            ...
            {
                [StdSchedulerFactory.PropertySchedulerName] = "DI.Quartz.Scheduler",
