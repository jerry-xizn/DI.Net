namespace DI.Quartz.Constants
{
    public class ScheduleConstants
    {
        ...
        public static string[] JOB_WHITELIST_STR = new string[] { "DI" };

        // 定时任务违规的字符
        public static string[] JOB_ERROR_STR = new string[] { "DI.Framework", "DI.Data", "DI.Common" };
    }
}
