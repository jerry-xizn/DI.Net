...
namespace DI.Quartz.Controllers
{
    /// <summary>
    /// 调度任务信息操作处理
    /// </summary>
    ...
    public class SysJobController : ControllerBase
    {
        ...
        [DI.System.Log(Title = "定时任务", BusinessType = BusinessType.INSERT)]
        ...
        [TypeFilter(typeof(DI.Framework.DataValidation.DataValidationFilter))]
        [DI.System.Log(Title = "定时任务", BusinessType = BusinessType.UPDATE)]
        ...
        [DI.System.Log(Title = "定时任务", BusinessType = BusinessType.DELETE)]
