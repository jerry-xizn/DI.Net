...
namespace DI.Generator.Utils
{
    ...
    {
        /** 根路径 */
        private static string ROOT_PATH = "DI";
        ...
        public static TemplateContext PrepareContext(GenTable genTable)
        {
            var context = new TemplateContext
            {
                ...
                PackageName = !string.IsNullOrEmpty(genTable?.PackageName) ? genTable.PackageName : "DI",
        ...
        public static string GetFileName(string template, GenTable genTable)
        {
            ...
            string fileName = "";
            // 包路径
            //string packageName = !string.IsNullOrEmpty(genTable.PackageName) ? genTable.PackageName : "DI";
            // 模块名
        ...
        public static string Compile(TemplateContext context, string templatePath)
        {
            ...
            {
                //builder.AddUsing("DI.Data.Entities"); // using

                builder.AddAssemblyReferenceByName("System.Collections");  // by name
                builder.AddAssemblyReferenceByName("DI.Data");  // by name

                builder.AddAssemblyReference(typeof(DI.Generator.Dtos.TemplateContext)); // by type
