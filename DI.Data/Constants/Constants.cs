namespace DI.Data
{
    ...
    public class Constants
    {
         ...
         */
        public static string[] JSON_WHITELIST_STR = { "org.springframework", "com.di" };

        /**
         * 定时任务白名单配置（仅允许访问的包名，如其他需要可以自行添加）
         */
        public static string[] JOB_WHITELIST_STR = { "com.di" };

        /**
         * 定时任务违规的字符
         */
        public static string[] JOB_ERROR_STR = { "java.net.URL", "javax.naming.InitialContext", "org.yaml.snakeyaml",
            "org.springframework", "org.apache", "com.di.common.utils.file", "com.di.common.config" };
    }
}
