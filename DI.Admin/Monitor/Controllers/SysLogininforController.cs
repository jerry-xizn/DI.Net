...
namespace DI.System.Controllers
{
    ...
    public class SysLogininforController : ControllerBase
    {
        ...
        [DI.System.Log(Title = "系统访问记录", BusinessType = BusinessType.INSERT)]
        ...
        [TypeFilter(typeof(DI.Framework.DataValidation.DataValidationFilter))]
        [DI.System.Log(Title = "系统访问记录", BusinessType = BusinessType.UPDATE)]
        ...
        [DI.System.Log(Title = "系统访问记录", BusinessType = BusinessType.DELETE)]
        ...
        [DI.System.Log(Title = "系统访问记录", BusinessType = BusinessType.IMPORT)]
        ...
        [DI.System.Log(Title = "系统访问记录", BusinessType = BusinessType.EXPORT)]
