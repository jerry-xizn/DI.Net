...
namespace DI.System.Controllers
{
    ...
    public class SysOperLogController : ControllerBase
    {
        ...
        [DI.System.Log(Title = "操作日志", BusinessType = BusinessType.DELETE)]
        ...
        [HttpDelete("clean")]
        [AppAuthorize("system:log:remove")]
        [DI.System.Log(Title = "操作日志", BusinessType = BusinessType.CLEAN)]
        ...
        [DI.System.Log(Title = "操作日志", BusinessType = BusinessType.EXPORT)]
